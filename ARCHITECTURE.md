...
| Does buying the close and selling the open survive costs? | **No — and the gross edge is mostly a mega-cap artifact.** On the 65-name pool it grosses 12.8% CAGR at Sharpe 1.37. On **point-in-time S&P membership, 2007-2026 (~417 names/day), it grosses only 7.9% at Sharpe 0.69 vs SPY's 11.0% at 0.63** — essentially no risk-adjusted edge before costs. Net of the 6bp/side model: **-20.2% CAGR**, breakeven near 1-2bp. A daily round trip pays the spread ~504 times a year (30% of capital annually); buy-and-hold pays it twice. Same shape as the sentiment tilt: strong on a curated pool, gone on the broad one. |
